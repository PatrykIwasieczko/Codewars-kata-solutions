...
If there is more than one condition to judge, we can use the compound if...else 
...
is the number of customers to buy hotdogs, different numbers have different 
